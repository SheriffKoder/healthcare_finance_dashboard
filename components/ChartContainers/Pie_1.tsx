...
// How much each service got paid having the selected option
  const Pie1_CharData:pieCharDataType[] = []
  let allServicesPay = 0;

  // how much each service got paid in the selected facility
  ...
  // how much each service got paid from the selected payer
  ...
  // how much each service got paid in the selected year
    ...
    ">
      ...
      <div className='flex-1 flex flex-col gap-6 justify-center' >
          ...
          {/* <p className='w-full text-center'>Services</p> */}
            ...
            {/* // display all services existing in the calculated data */}
